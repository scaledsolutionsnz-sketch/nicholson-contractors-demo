# Nicholson Contractors — build checklist
...
- Two Google ratings verified: joshua millar (5 stars, 4 years ago) and Sam Nicholson (5 stars, 7 years ago). Neither includes written text; cards explicitly state rating only.
- Google and the Feilding directory match the phone and location. Similarly named Australian and Waikato contractors were excluded. Existing email/contact retained without independent email verification.
- No independently verified social profile or official logo found; Facebook search is explicitly labelled. Existing illustrative photos retained and gallery labelled.

- Google Place ID: `ChIJ3a2qFYJKQG0RBZfmLG000B4`. [Read Google reviews](https://search.google.com/local/reviews?placeid=ChIJ3a2qFYJKQG0RBZfmLG000B4); [direct write-review link](https://search.google.com/local/writereview?placeid=ChIJ3a2qFYJKQG0RBZfmLG000B4). Review dates retain the relative wording Google displayed at capture.
...
Live: https://nicholson-contractors-demo.vercel.app

GitHub: https://github.com/scaledsolutionsnz-sketch/nicholson-contractors-demo

Local folder: /Users/wiremubartlett/Desktop/builds/nicholson-contractors-demo
